...
TEST(loot_drop_entry_test, with_attribute_config)
{
    ...
    entry.attribute = loot_attribute_config{
        .max_upgrade_level = 3, .enchantment_chance = 50, .sub_enchantment_chance = 30, .max_enchantment_value = 5};
...
{
    nlohmann::json j = {{"player_name", "TestPlayer"}, {"item_template_id", 100}, {"count", 1}};
