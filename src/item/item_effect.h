    ...
    if (attr.upgrade_level > 0) {
        ...
        if (itm.type == item_type::weapon) {
            ...
            for (const auto& effect : itm.effects) {
                ...
                if (bonus == 0 && n > 0) bonus = 1;  // Minimum +1 per upgrade

                switch (effect.type) {
                    case item_effect_type::hp_bonus: mods.hp_bonus += bonus; break;
                    case item_effect_type::mp_bonus: mods.mp_bonus += bonus; break;
                    case item_effect_type::sp_bonus: mods.sp_bonus += bonus; break;
                    case item_effect_type::str_bonus: mods.strength += bonus; break;
                    case item_effect_type::dex_bonus: mods.dexterity += bonus; break;
                    case item_effect_type::vit_bonus: mods.vitality += bonus; break;
                    case item_effect_type::int_bonus: mods.intelligence += bonus; break;
                    case item_effect_type::mag_bonus: mods.magic += bonus; break;
                    case item_effect_type::chr_bonus: mods.charisma += bonus; break;
                    case item_effect_type::attack_bonus: mods.attack_power += bonus; break;
                    case item_effect_type::defense_bonus: mods.defense += bonus; break;
                    case item_effect_type::magic_attack_bonus: mods.magic_power += bonus; break;
                    case item_effect_type::magic_defense_bonus: mods.magic_defense += bonus; break;
                    case item_effect_type::hit_bonus: mods.hit_bonus += bonus; break;
                    case item_effect_type::dodge_bonus: mods.dodge_bonus += bonus; break;
                    case item_effect_type::critical_bonus: mods.critical_rate += bonus; break;
                    case item_effect_type::damage_reduction: mods.physical_resist += bonus; break;
                    default: break;
                }
            }
        }
