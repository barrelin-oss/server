...
auto random_mob_generator::get_random_npc(int level) -> std::optional<random_npc_choice> {
    ...
    switch (level) {
        case 1: return select_level_1();
        case 2: return select_level_2();
        case 3: return select_level_3();
        case 4: return select_level_4();
        case 5: return select_level_5();
        case 6: return select_level_6();
        case 7: return select_level_7();
...
auto random_mob_generator::select_level_3() -> random_npc_choice {
    ...
    if (roll >= 1 && roll < 20) {
        // Orc or Zombie
        return roll_dice(1, 2) == 1 ? random_npc_choice{"Orc", npc_id{14}}
                                    : random_npc_choice{"Zombie", npc_id{18}};
    }
        ...
        switch (sub) {
            case 1: return {"Skeleton", npc_id{11}};
            case 2: return {"Orc-Mage", npc_id{14}};
            case 3: return {"Scorpion", npc_id{17}};
            default: return {"Skeleton", npc_id{11}};
        }
    }
        ...
        switch (sub) {
            case 1:
            case 2: return {"Stone-Golem", npc_id{12}};
            case 3: return {"Clay-Golem", npc_id{23}};
            case 4: return {"Troll", npc_id{28}};
            case 5: return {"WereWolf", npc_id{33}};
            case 6: return {"Giant-Frog", npc_id{57}};
            case 7: return {"Ettin", npc_id{59}};
            default: return {"Stone-Golem", npc_id{12}};
        }
    }
    else {  // 75-100
        ...
        switch (sub) {
            case 1:
            case 2: return {"Cyclops", npc_id{13}};
            case 3: return {"Orge", npc_id{29}};
            case 4: return {"Hellbound", npc_id{27}};
            case 5: return {"Mountain-Giant", npc_id{58}};
            default: return {"Cyclops", npc_id{13}};
        }
    }
}
...
auto random_mob_generator::select_level_5() -> random_npc_choice {
    ...
    if (roll >= 1 && roll < 30) {
        ...
        int sub = roll_dice(1, 3);
        switch (sub) {
            case 1: return {"Clay-Golem", npc_id{23}};
            case 2: return {"Hellbound", npc_id{27}};
            case 3: return {"Cyclops", npc_id{13}};
            default: return {"Clay-Golem", npc_id{23}};
        }
    }
}
...
auto random_mob_generator::select_level_6() -> random_npc_choice {
    ...
    if (roll >= 1 && roll < 60) {
        ...
        switch (sub) {
            case 1:
            case 2: return {"Stone-Golem", npc_id{12}};
            case 3: return {"Troll", npc_id{28}};
            case 4: return {"Cyclops", npc_id{13}};
            case 5: return {"Tentocle", npc_id{43}};
            default: return {"Stone-Golem", npc_id{12}};
        }
    }
    else {  // 90-100
        ...
        switch (sub) {
            case 1: return {"Giant-Frog", npc_id{57}};
            case 2: return {"Cyclops", npc_id{13}};
            case 3: return {"Orge", npc_id{29}};
            case 4: return {"Hellbound", npc_id{27}};
            case 5: return {"WereWolf", npc_id{33}};
            case 6: return {"Ettin", npc_id{59}};
            case 7: return {"Mountain-Giant", npc_id{58}};
            case 8: return {"Cannibal-Plant", npc_id{60}};
            default: return {"Cyclops", npc_id{13}};
        }
    }
}
...
auto random_mob_generator::select_level_7() -> random_npc_choice {
    ...
    if (roll >= 1 && roll < 50) {
        ...
        int sub = roll_dice(1, 3);
        switch (sub) {
            case 1: return {"Orge", npc_id{29}};
            case 2: return {"Hellbound", npc_id{27}};
            case 3: return {"Liche", npc_id{30}};
            default: return {"Orge", npc_id{29}};
        }
    }
    else if (roll >= 50 && roll < 80) {
        ...
        int sub = roll_dice(1, 3);
        switch (sub) {
            case 1: return {"Liche", npc_id{30}};
            case 2: return {"Demon", npc_id{31}};
            case 3: return {"Unicorn", npc_id{32}};
            default: return {"Liche", npc_id{30}};
        }
    }
    else {  // 80-100
        // Elite monsters
        int sub = roll_dice(1, 7);
        switch (sub) {
            case 1: return {"Gagoyle", npc_id{52}};
            case 2: return {"Beholder", npc_id{53}};
            case 3: return {"Dark-Elf", npc_id{54}};
            case 4: return {"Ice-Golem", npc_id{65}};
            case 5: return {"DireBoar", npc_id{62}};
            case 6: return {"Frost", npc_id{63}};
            case 7: return {"Wyvern", npc_id{66}};
            default: return {"Gagoyle", npc_id{52}};
        }
    }
}
