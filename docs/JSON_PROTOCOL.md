...
**32 request/response pairs** covering: server stats, player/map/guild/inventory management, spectator mode, server broadcasts, mute management, item/NPC template browsing, war status, party inspection, and player search.
