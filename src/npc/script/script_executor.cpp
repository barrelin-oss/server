...
void script_executor::execute_action(entity::entity npc_entity, const script_action& action)
{
    ...
    case action_type::say:
        LOG_DEBUG(general, "NPC {} '{}' says: {}", npc_entity.id, npc_ptr->name, action.str_param);
    ...
    case action_type::emote:
        LOG_DEBUG(general, "NPC {} '{}' emote: {}", npc_entity.id, npc_ptr->name, action.str_param);
    ...
    case action_type::apply_buff:
        ...
        LOG_DEBUG(general, "NPC {} applying buff '{}' radius {}", npc_entity.id, action.str_param, action.int_param2);
        break;
    ...
    case action_type::set_invincible:
        ...
        LOG_DEBUG(general, "NPC {} invincible: {}", npc_entity.id, action.bool_param);
        break;

    case action_type::play_effect:
        LOG_DEBUG(
            general, "NPC {} play effect '{}' at ({},{})", npc_entity.id, action.str_param, action.pos.x, action.pos.y);
        // TODO: Broadcast visual/sound effect
        break;

    case action_type::call_script:
        // TODO: Start sub-script (needs access to script_loader)
        LOG_DEBUG(general, "NPC {} call_script '{}'", npc_entity.id, action.str_param);
        break;
    }
}
