...
struct item_template
{
    ...
    // Helper methods
    [[nodiscard]] auto is_weapon() const -> bool { return type == item_type::weapon; }

    [[nodiscard]] auto is_armor() const -> bool { return type == item_type::armor; }

    [[nodiscard]] auto is_equippable() const -> bool { return equip_pos != item_equip_pos::none; }
    ...
    [[nodiscard]] auto is_bow() const -> bool { return equip_pos == item_equip_pos::two_hand && sprite_id == 2; }

    [[nodiscard]] auto is_arrow() const -> bool { return type == item_type::arrow; }

    [[nodiscard]] auto is_usable() const -> bool { return type == item_type::eat || type == item_type::use_deplete; }
};
